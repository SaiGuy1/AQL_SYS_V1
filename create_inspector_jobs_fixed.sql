...
-- Run this in the Supabase SQL Editor AFTER running fix_assigned_to_column.sql
...
BEGIN
    ...
    INSERT INTO public.jobs (
        ...
        inspector_id,
        inspector,
        "assignedTo", -- Note the quotes for camelCase column name
        safety_requirements,
        defect_guidelines,
        instructions,
        ...
        inspector_id,
        'John Smith',
        inspector_id, -- assignedTo matches the inspector_id
...
SELECT id, title, job_number, status, inspector, "assignedTo", estimated_hours, created_at 
FROM public.jobs 
