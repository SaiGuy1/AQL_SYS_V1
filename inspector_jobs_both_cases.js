...
// This version adds properties in both camelCase and lowercase to avoid case mismatch issues
(function addInspectorJobsBothCases() {
  console.log("Adding inspector jobs to localStorage with both case versions...");
  ...
  const mockJobs = [
    {
      ...
      // Include both camelCase and lowercase versions of the properties
      inspector_id: "insp-1",
      inspectorid: "insp-1",
  ...
  console.log(`✅ Successfully added ${mockJobs.length} inspector jobs to localStorage with both camelCase and lowercase properties!`);
  ...
  return `Added ${mockJobs.length} inspector jobs to localStorage with both camelCase and lowercase properties. Refresh the page to see them.`;
})(); 